...
function runWithInput(command, args, input) {
  // wl-copy and xclip fork a child that keeps serving the selection and
  // inherits the pipes, so anything waiting for stdio to close would hang
  // forever. Ignore their output and settle on the parent's exit alone.
